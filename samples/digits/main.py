...
def main():
    ...
    train_images_path = directory+"/train-images-idx3-ubyteh"
    train_labels_path = directory+"/train-labels-idx1-ubyteh"
    test_images_path = directory+"/t10k-images-idx3-ubyte"
    test_labels_path = directory+"/t10k-labels-idx1-ubyte"

    train_images=utils.mnist.loadImages(train_images_path)
    train_labels=utils.mnist.loadLabels(train_labels_path)
    test_images=utils.mnist.loadImages(test_images_path)
    test_labels=utils.mnist.loadLabels(test_labels_path)
